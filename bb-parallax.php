...
//     wp_register_script('wpac', plugins_url('/wpac.js', __FILE__), array('jquery', 'gsap', 'scrolltrigger'), '1.0', true);

//     // Enqueue the scripts
//     wp_enqueue_script('gsap');
//     wp_enqueue_script('scrolltrigger');
//     //wp_enqueue_script('bb-parallax');
//     wp_enqueue_script('wpac');
...
add_action('wp_enqueue_scripts', 'bb_parallax_enqueue_scripts');
//add_action('fl_builder_ui_enqueue_scripts', 'bb_parallax_enqueue_scripts');
